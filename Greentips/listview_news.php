...
<body>
        ...
        <nav>
            <div class="navigasi">
                <ul>
                    ...
                    <li><a href="listview_article.php">Article</a></li>
                    <li><a href="listview_news.php" class='active'>Health News</a></li>
    ...
    <div class="list_container">
        <div class="inner_list_container">
            <div class="column">
                <a href="news.html" class= "warnaFont">
                    <div class="column_bi">
                    <h2>Corona</h2>
            ...
            <div class="column">
                <a href="#" class= "warnaFont">
                    <div class="column_bi">
                        <hr>
                        <h2>Geger RPL ga kelar kelar</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum 
                            interdum, nisi lorem egestas vitae scel<span id="dots">...</span><span id="more">erisque enim 
                            ligula venenatis dolor. Maecenas nisl est, ultrices nec congue eget, auctor vitae massa. Fusce 
                            luctus vestibulum augue ut aliquet. Nunc sagittis dictum nisi, sed ullamcorper ipsum dignissim 
            ...
            <div class="column">
                <a href="#" class= "warnaFont">
                    <div class="column_bi">
                            <hr>
                            <h2>10 tips terbaik agar basprog dapat A</h2>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum 
                                interdum, nisi lorem egestas vitae scel<span id="dots">...</span><span id="more">erisque enim 
                                ligula venenatis dolor. Maecenas nisl est, ultrices nec congue eget, auctor vitae massa. Fusce 
                                luctus vestibulum augue ut aliquet. Nunc sagittis dictum nisi, sed ullamcorper ipsum dignissim 
