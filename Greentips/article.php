        ...
        <nav>
            <div class="navigasi">
                <ul>
                    ...
                    <li><a href="listview_article.php" class='active'>Article</a></li>
                    <li><a href="listview_news.php">Health News</a></li>
                    <li><a href="bmi.php">BMI Calculator</a></li>
                    <li><a href="nuf.php">Nutrition of Food</a></li>
                </ul>
            </div>
        </nav>
    </header>
...
<div class="art_container">
    <div class="main">
        ...
        <br>
        <p class="isi"><b>Penyakit asam lambung atau gastroesophageal reflux disease (GERD) adalah muncul
             nya rasa terbakar di dada akibat asam lambung naik ke kerongkongan. Gejala penyakit 
             asam lambung muncul minimal 2 kali dalam seminggu. 
            </b></p>
        <br>
        <p class="isi">
    ...
    <div class="sidebar">
        <div class="inner_sidebar">
         ...
         <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus imperdiet, nulla et dictum 
            ...
            tempor porta.</span></p>
            <button href= "article.html">Read More</button>
         <hr>
    </div>
    </div>
</div>
